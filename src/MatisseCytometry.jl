...
export color_figure, set_project, get_target_list, sm_heatmap
#export color_figure
using ColorSchemes
...
function color_figure(img_file, pairs...; mask_dir="", 
    window = nothing, name = "untitled_$(rand(0:9,4)...)",
    figpath = FIG_PATH(), datpath = DATA_PATH(), colorscale = 0.7)
    # need to fix the name generation, not all patients get their own number.
